...
mod tests {
    ...
    // fn test_build_iana_org_reply() {
    //     use crate::{PacketHeader, Reply};
    ...
    //         nscount: 0,
    //     };
    //     let qname = String::from("iana.org");
    ...
    //     let answer = crate::ResourceRecord {
    //         name: qname,
    ...
    //         answer,
    //     };
    //     let reply_bytes: Vec<u8> = reply.into();
    ...
    fn test_build_ackcdn_allzeros() {
        ...
        let qname = String::from("ackcdn.com");
        let question = Question {
            qname: qname.clone(),
            qtype: crate::RecordType::A,
            qclass: crate::RecordClass::Internet,
        ...
        let expected_bytes = [
            ...
            /* question - 16 bytes */
            0x06, 0x61, 0x63, 0x6b, 0x63, 0x64, 0x6e, 0x03,
            0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01,
            /* answer - 16 bytes  */
            0b11000000, 0x0c, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00,
