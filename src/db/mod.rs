...
// //     /// Get by id
// //     async fn get(_pool: &DatabaseConnection, _id: i64) -> Result<Box<Self>, GoatNsError> {
...
// //     }
// //     /// delete the entity from the database
// //     async fn delete(&self, _pool: &DatabaseConnection) -> Result<(), GoatNsError> {
// //         todo!()
// //     }
...
// //     //     id: Uuid,
// //     // ) -> Result<Vec<Arc<Self>>, GoatNsError> {
// //     //     let res = entities::user_tokens::Entity::find().filter(
// //     //         entities::user_tokens::Column::Userid.eq(id),
// //     //     ).all(pool).await?;
